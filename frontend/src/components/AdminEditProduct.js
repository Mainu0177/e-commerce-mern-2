...
const AdminEditProduct = ({onClose,productData}) => {
    ...
    return (
        <div className='bg-slate-200 bg-opacity-35 fixed mt-8 flex h-full w-full top-0 left-0 right-0 bottom-0 justify-center items-center'>
        <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
            <div className='flex justify-between items-center pb-3'>
            <h2 className='font-bold text-lg'>Upload Products</h2>
            <div className='ml-auto w-fit text-2xl hover:text-red-600 cursor-pointer' onClick={onClose}>
                <CgClose />
            </div>
            </div>
