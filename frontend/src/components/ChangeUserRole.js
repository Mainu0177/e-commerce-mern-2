...
const ChangeUserRole = ({name, email, role, onClose, callFunc, userId}) => {
  ...
  return (
    <div  className='fixed top-0 right-0 left-0 bottom-0 w-full h-full z-10 flex justify-between items-center bg-slate-200 bg-opacity-50'>
